...
CHUNK_SIZE = 550        # keep short student posts intact while still splitting longer answers
CHUNK_OVERLAP = 80      # retain a little context between neighbouring chunks
